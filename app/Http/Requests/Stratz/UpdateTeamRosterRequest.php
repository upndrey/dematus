...
class UpdateTeamRosterRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            $currentSlug = $this->route('teamRoster');

            if (
                is_string($this->input('name'))
                && $repository->existsWithName((string) $this->input('name'), is_string($currentSlug) ? $currentSlug : null)
            ) {
