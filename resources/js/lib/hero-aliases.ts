...
const manualRussianAliasesByHeroId: Record<number, string[]> = {
    ...
    14: [
        ...
        'джуп',
        'обычный пудж',
        'обычный пудж нейтральный',
        'обычный пудж модный',
        'обычный пудж сексуальный',
        'обычный пудж сексуальный с момом и башером',
        'доктор мом',
    ],
    21: ['виндра'],
    39: ['квоп', 'квопа'],
...
const manualExtraAliasesByHeroId: Record<number, string[]> = {
    29: ['арбуз'],
    40: ['некит'],
    60: ['ярослав'],
    86: ['андрей'],
...
export const getHeroSearchAliases = (hero: HeroSearchHero): string[] => {
    const baseAliases = [
        ...
        ...(manualExtraAliasesByHeroId[hero.id] ?? []),
    ];
