    ...
    <div class="min-h-screen bg-slate-950 text-slate-100">
        <div class="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-8 md:px-8">
            ...
            >
                ...
                <button
                    type="button"
                    class="w-full rounded-xl bg-violet-400 px-4 py-3 text-sm font-semibold text-slate-950 transition hover:bg-violet-300 disabled:cursor-not-allowed disabled:opacity-60 md:w-auto"
...
const submitRoshByGist = async (): Promise<void> => {
    await request('rosh-gist', roshGistAction.post(), {});
};
